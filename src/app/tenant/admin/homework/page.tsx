    ...
    <>
      <main className="flex-1 overflow-y-auto bg-background">
        ...
        <div className="space-y-6 p-6">
          <HomeworkForm />
          <Card>
            <CardHeader><CardTitle>অ্যাসাইনমেন্ট তালিকা</CardTitle></CardHeader>
            <CardContent className="space-y-2">
              {items.length === 0 ? <p className="text-sm text-muted-foreground">কোনো হোমওয়ার্ক নেই</p> : items.map((h) => (
                <div key={h.id} className="flex justify-between rounded-lg border px-3 py-2 text-sm">
                  <div>
